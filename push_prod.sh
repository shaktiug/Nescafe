...
then
ssh -i dev-aws.pem ec2-user@34.222.1.157 "sudo cp /var/www/html/${config_type} /var/www/html/${config_type}.bak"
fi
...
ssh -i dev-aws.pem ec2-user@34.222.1.157 "sudo service httpd restart"
...
if [ -f /var/www/html/${config_type} ];
then
ssh -i dev-aws.pem ec2-user@34.212.29.187 "sudo cp /var/www/html/${config_type} /var/www/html/${config_type}.bak"
fi
echo " Deploying the new ${config_type} "
...
ssh -i dev-aws.pem ec2-user@34.212.29.187 "sudo service httpd restart"